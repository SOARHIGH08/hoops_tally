...
//   user: "if0_35085595",
//   password: "AU2842SX5mStI",
//   database: "if0_35085595_hoops_apps",
//   // connectionLimit: 10,
// });
const db = mysql.createPool({
  host: "localhost",
...
app.post("/teams/addPlayers", (req, res) => {
  ...
  players.forEach((player) => {
    ...
    const sqlInsertPlayers =
      "INSERT INTO players_and_overall_stats (team_id, first_name, last_name, jersey_num) VALUES (?, ?, ?, ?)";
...
app.get("/games-list", (req, res) => {
  const organizer_id = req.query.organizer_id || 0;
  const game_status = req.query.game_status || 0;
